# Shared behavioral contract for DecisionModel and Projection on top of a
# real store: the combined query must be filtered by type and tags exactly
# like the individual projection queries, and the returned AppendCondition
# must guard the boundary the projections were built from.
#
# Including classes must set @store in setup.
module DecisionModelContract
